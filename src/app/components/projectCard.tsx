...
export function ProjectCard({name, description, image, repo, tags, url, stack}: projectType){
  return (
    <a href={url} target="_blank">
      <div className="h-96 flex flex-col overflow-hidden relative rounded-lg justify-start items-center gap-6 w-[400px] bg-secondary px-4 py-8 mt-4 hover:h-full hover:duration-500 hover:scale-105 transition-all ease-in-out duration-500">
